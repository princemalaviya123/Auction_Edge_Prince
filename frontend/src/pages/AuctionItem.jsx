...
export const AuctionItem = () => {
    ...
    return (
        <>
            ...
            {/* <input
                                                type="number"
                                                className="bg-white h-10 w-32 p-2 text-lg border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 md:text-[20px]"
                                                value={amount}
                                                onChange={(e) => setAmount(e.target.value)}
                                            />
                                        ...
                                        <button
                                            className="p-4 text-white bg-black rounded-full transition-all duration-300 hover:bg-[#D6482B] cursor-pointer"
                                            onClick={handleBid}
                                        >
                                            <RiAuctionFill />
                                        </button>
