...
<section className="my-8 lg:px-5 text-white">
  <div className="flex flex-col min-[340px]:flex-row min-[340px]:gap-2">
    <h3 className="text-white text-xl font-semibold mb-2 min-[480px]:text-xl md:text-2xl lg:text-3xl">
      Top 10
    </h3>
    <h3 className="text-red-400 text-xl font-semibold mb-2 min-[480px]:text-xl md:text-2xl lg:text-3xl">
      Bidders Leaderboard
    </h3>
  </div>
  <div className="overflow-x-auto bg-gradient-to-b from-gray-900 via-gray-800 to-black p-4 rounded-md shadow-lg">
    <table className="min-w-full border border-gray-700">
      <thead>
        <tr className="bg-gray-800 text-white">
          <th className="py-2 px-4 text-left border-b border-gray-700">Profile Pic</th>
          <th className="py-2 px-4 text-left border-b border-gray-700">Username</th>
          <th className="py-2 px-4 text-left border-b border-gray-700">Bid Expenditure</th>
          <th className="py-2 px-4 text-left border-b border-gray-700">Auctions Won</th>
        </tr>
      </thead>
      <tbody className="text-gray-300">
        {leaderboard.slice(0, 10).map((element, index) => (
          <tr key={element._id} className="border-b border-gray-700 hover:bg-gray-800 transition-all">
            <td className="flex gap-2 items-center py-2 px-4">
              <span className="text-gray-500 font-semibold text-xl w-7 hidden sm:block">
                {index + 1}
              </span>
              <span>
                <img
  ...
  <Link
    to={"/leaderboard"}
    className="border-2 border-gray-600 font-bold text-xl w-full py-2 flex justify-center rounded-md hover:border-[#D6482B] text-white transition-all duration-300 mt-4"
  >
    Go to Leaderboard
  </Link>
</section>
