  ...
  return (
    <>
      {loading ? (
        ...
        <>
          <div className="bg-[#90A4AE] w-full ml-0 m-0 h-fit px-5 pt-20 lg:pl-[320px] flex flex-col gap-10">
            <h1
            ...
            <div className="flex flex-col gap-10">
              <div>
                <h3 className="text-gray text-xl font-semibold mb-2 min-[480px]:text-xl md:text-2xl lg:text-3xl">
