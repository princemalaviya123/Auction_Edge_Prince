...
const CreateAuction = () => {
    ...
    return (
        ...
        <article className="w-full ml-0 m-0 h-fit px-5 pt-20 lg:pl-[320px] flex flex-col bg-gradient-to-b from-gray-900 via-gray-800 to-black min-h-screen">
  <h1 className="text-[#d6482b] text-2xl font-bold mb-2 min-[480px]:text-4xl md:text-6xl xl:text-7xl 2xl:text-8xl">
    Create Auction
  </h1>
  <div className="bg-gradient-to-b from-gray-900 via-gray-800 to-black mx-auto w-full h-auto px-4 flex flex-col gap-4 items-center py-6 justify-center rounded-md shadow-md">
    <form className="flex flex-col gap-5 w-full" onSubmit={handleCreateAuction}>
      <p className="font-semibold text-xl md:text-2xl text-white">Auction Details</p>
      ...
      <div className="flex flex-col gap-4 sm:flex-row">
        <div className="flex flex-col sm:flex-1">
          ...
          <input
            ...
            value={title}
            onChange={(e) => setTitle(e.target.value)}
            className="py-2 bg-transparent border-b border-gray-500 focus:outline-none text-white focus:border-yellow-400"
          />
        </div>
        <div className="flex flex-col sm:flex-1">
      ...
      <div className="flex flex-col gap-4 sm:flex-row">
        ...
        <div className="flex flex-col sm:flex-1">
          <label className="text-gray-400">Starting Bid</label>
          <input
            type="number"
            value={startingBid}
            onChange={(e) => setStartingBid(e.target.value)}
      ...
      <div className="flex flex-col">
        ...
        <textarea
          value={description}
          onChange={(e) => setDescription(e.target.value)}
          className="focus:border-yellow-400 py-2 bg-transparent border border-gray-500 focus:outline-none text-white p-2 rounded-md"
          rows={5}
        />
      </div>
      ...
      <div className="flex flex-col gap-4 sm:flex-row">
        <div className="flex flex-col sm:flex-1">
          <label className="text-gray-400">Auction Start Time</label>
          <DatePicker
            selected={startTime}
            onChange={(date) => setStartTime(date)}
            showTimeSelect
            ...
            timeIntervals={15}
            dateFormat="MMMM d, yyyy h:mm aa"
            className="focus:border-yellow-400 py-2 bg-transparent border-b border-gray-500 focus:outline-none w-full text-white"
          />
        </div>
        <div className="flex flex-col sm:flex-1">
          <label className="text-gray-400">Auction End Time</label>
          <DatePicker
            selected={endTime}
            onChange={(date) => setEndTime(date)}
            showTimeSelect
      ...
      {/* Image Upload */}
      <div className="flex flex-col gap-4">
        <label className="font-semibold text-xl md:text-2xl text-white">Auction Item Image</label>
      ...
      {/* Submit Button */}
      <button className="bg-[#D6482B] font-semibold hover:bg-[#b8381e] text-xl transition-all duration-300 py-2 px-4 rounded-md text-white w-full sm:w-[640px] mx-auto my-4">
